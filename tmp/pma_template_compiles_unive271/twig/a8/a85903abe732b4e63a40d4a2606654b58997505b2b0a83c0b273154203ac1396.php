...
class __TwigTemplate_4410e114fc5a1316557b8615612fadaac263c8b45528ebbe5ffb52029ffd36ca extends Twig_Template
{
...
";
    ...
    <form method=\"post\" id=\"tblchartform\" action=\"tbl_chart.php\" class=\"ajax\">
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 75
            echo "                        ";
            if (twig_in_filter($this->getAttribute($this->getAttribute(($context["fields_meta"] ?? null), $context["idx"], array(), "array"), "type", array()), ($context["numeric_types"] ?? null))) {
                // line 76
                echo "                            ";
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 87
            echo "                        ";
            if (twig_in_filter($this->getAttribute($this->getAttribute(($context["fields_meta"] ?? null), $context["idx"], array(), "array"), "type", array()), ($context["date_time_types"] ?? null))) {
                // line 88
                echo "                            ";
                echo twig_escape_filter($this->env, ($context["idx"] . " "), "html", null, true);
                echo "
        ...
        // line 104
        echo twig_escape_filter($this->env, (((($context["xaxis"] ?? null) ==  -1)) ? (_gettext("X Values")) : ($this->getAttribute(($context["keys"] ?? null), ($context["xaxis"] ?? null), array(), "array"))), "html", null, true);
        echo "\" />
                <br />
...
";
    ...
    {
        return new Twig_Source("", "table/chart/tbl_chart.twig", "/usr/local/cpanel/base/3rdparty/phpMyAdmin/templates/table/chart/tbl_chart.twig");
    }
}
